programa
{
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DO ADICIONAL NOTURNO ---------// 
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DAS FERIAS---------//  
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DO FGTS ---------//  
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DAS HORAS EXTRAS ---------//  
	...
	funcao real calculo_hora_extra(real salario, real aumento_hora_extra)
	{
		...
		real hora_extra_uteis, hora__feriado_domingo
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DO IMPOSTO DE RENDA ---------// 
	funcao salario_colaborador_imposto_de_renda()
	{
		const real desconto = 0
		real salario

		escreva("\n informe o salﾃ｡rio do funcionario: \n")
		leia(salario)
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DO INSS --------//
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DA PERICULOSIDADE ---------//  
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DO PIS ---------//  
	...
	// ---------- FUNﾃ�ﾃグ RESPONSﾃ〃EL POR PEGAR O SALﾃヽIO DO VALE TRANSPORTE //  
	...
	//--------- FUNﾃ�ﾃグ RESPOSAVEL PELO SALﾃヽIO DO COMPILADOR ------------- //
	funcao salario_colaborador_compilador_de_programas()
	{
		const real desconto = 0
		real salario
		
		escreva("\n informe o saalrio do funcionario: \n")
		leia(salario)
	...
	funcao seletor_programa(inteiro opcao)
	{
		escolha(opcao)
		{
			...
			caso contrario:
				escreva("\nescolha uma opção valida, obrigado \n")
		}
	}
	
	//--------- FUNﾃ�ﾃグ SVOLTAR AO MENU ------------- //
 ...
 * 
 * @POSICAO-CURSOR = 32966; 
 * @DOBRAMENTO-CODIGO = [57, 80, 107, 130, 154, 177, 191, 213, 298, 321, 370, 393, 448, 471, 488, 511, 562, 585, 634, 778, 915];
 * @PONTOS-DE-PARADA = ;
